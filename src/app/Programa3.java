...
public class Programa3 {
	...
	public static void metodo1() {
		...
		Operador newTelefone = new Operador();
		...
		if (resposta.equals(2)) { // Professor
			...
			if (resposta_locacao.equals(1)) { // NOVA LOCACAO
				...
				if (dias_previstos > 10) {
					...
					newLocacao = new Locacao(null, data_Retirada, data_Devolucao, newCliente, newCarro, newDiaria,
							newLocacaoPeriodo);
		 ...
		 * catch(RuntimeException e) { System.out.
		 * println("Ops! Não era para isso acontecer '-'.\nVerifique se clicou algo errado."
		 * ); }
